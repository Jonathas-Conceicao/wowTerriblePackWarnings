...
- `Data/WindrunnerSpire.lua` — npcID-keyed ability database for Windrunner Spire mobs
...
- SavedVariables: `TerriblePackWarningsDB` (account-wide) — stores debug flag, window position, imported route
