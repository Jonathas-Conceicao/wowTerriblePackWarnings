...
-- Only id (npcID), name, displayId, isBoss retained -- clone coordinates omitted
...
ns.DungeonEnemies[11] = {
    ...
    [9]  = { id = 122056, name = "Viceroy Nezhar", displayId = 78415, isBoss = true },
    [10] = { id = 122313, name = "Zuraal the Ascended", displayId = 77871, isBoss = true },
    [11] = { id = 122316, name = "Saprish", displayId = 143117, isBoss = true },
    [12] = { id = 122319, name = "Darkfang", displayId = 76602, isBoss = true },
    ...
    [19] = { id = 124729, name = "L'ura", displayId = 141808, isBoss = true },
    [20] = { id = 125340, name = "Shadewing", displayId = 78427, isBoss = true },
...
ns.DungeonEnemies[45] = {
    ...
    [6]  = { id = 194181, name = "Vexamus", displayId = 109099, isBoss = true },
    ...
    [10] = { id = 191736, name = "Crawth", displayId = 110805, isBoss = true },
    ...
    [14] = { id = 196482, name = "Overgrown Ancient", displayId = 109194, isBoss = true },
    [15] = { id = 196200, name = "Algeth'ar Echoknight", displayId = 109104 },
    [16] = { id = 196202, name = "Spectral Invoker", displayId = 109105 },
    [17] = { id = 190609, name = "Echo of Doragosa", displayId = 108925, isBoss = true },
}
...
ns.DungeonEnemies[150] = {
    ...
    [17] = { id = 252625, name = "Ick", displayId = 137500, isBoss = true },
    [18] = { id = 252635, name = "Forgemaster Garfrost", displayId = 137504, isBoss = true },
    [19] = { id = 252648, name = "Scourgelord Tyrannus", displayId = 137505, isBoss = true },
    [20] = { id = 252653, name = "Rimefang", displayId = 31154, isBoss = true },
    [21] = { id = 254684, name = "Rotling", displayId = 138343 },
    [22] = { id = 254691, name = "Scourge Plaguespreader", displayId = 138341 },
    [23] = { id = 255037, name = "Shade of Krick", displayId = 138601, isBoss = true },
}
...
ns.DungeonEnemies[151] = {
    ...
    [12] = { id = 75964, name = "Ranjit", displayId = 56015, isBoss = true },
    [13] = { id = 76141, name = "Araknath", displayId = 54006, isBoss = true },
    [14] = { id = 76142, name = "Skyreach Sun Construct Prototype", displayId = 56654 },
    [15] = { id = 76143, name = "Rukhran", displayId = 125047, isBoss = true },
    ...
    [19] = { id = 76266, name = "High Sage Viryx", displayId = 56016, isBoss = true },
...
ns.DungeonEnemies[152] = {
    ...
    [23] = { id = 231606, name = "Emberdawn", displayId = 123453, isBoss = true },
    [24] = { id = 231626, name = "Kalis", displayId = 125201, isBoss = true },
    [25] = { id = 231629, name = "Latch", displayId = 124335, isBoss = true },
    [26] = { id = 231631, name = "Commander Kroluk", displayId = 122981, isBoss = true },
    [27] = { id = 231636, name = "Restless Heart", displayId = 125199, isBoss = true },
...
ns.DungeonEnemies[153] = {
    ...
    [11] = { id = 231861, name = "Arcanotron Custos", displayId = 131334, isBoss = true },
    [12] = { id = 231863, name = "Seranel Sunlash", displayId = 127739, isBoss = true },
    [13] = { id = 231864, name = "Gemellus", displayId = 131317, isBoss = true },
    [14] = { id = 231865, name = "Degentrius", displayId = 132031, isBoss = true },
    ...
    [20] = { id = 239636, name = "Gemellus", displayId = 141672, isBoss = true },
    [21] = { id = 241354, name = "Void-Infused Brightscale", displayId = 127897 },
    [22] = { id = 241397, name = "Celestial Drifter", displayId = 98834, isBoss = true },
...
ns.DungeonEnemies[154] = {
    ...
    [19] = { id = 247570, name = "Muro'jin", displayId = 130699, isBoss = true },
    [20] = { id = 247572, name = "Nekraxx", displayId = 130705, isBoss = true },
    [21] = { id = 248595, name = "Vordaza", displayId = 131548, isBoss = true },
    [22] = { id = 248605, name = "Rak'tul", displayId = 131550, isBoss = true },
...
ns.DungeonEnemies[155] = {
    ...
    [17] = { id = 241539, name = "Kasreth", displayId = 131510, isBoss = true },
    [18] = { id = 241542, name = "Corewarden Nysarra", displayId = 131511, isBoss = true },
    [19] = { id = 241546, name = "Lothraxion", displayId = 137705, isBoss = true },
