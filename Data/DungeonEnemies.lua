...
ns.DungeonEnemies[11] = {
    ...
    [9]  = { id = 122056, name = "Viceroy Nezhar", isBoss = true, displayId = 78415 },
    [10] = { id = 122313, name = "Zuraal the Ascended", isBoss = true, displayId = 77871 },
    [11] = { id = 122316, name = "Saprish", isBoss = true, displayId = 76771 },
    [12] = { id = 122319, name = "Darkfang", isBoss = true, displayId = 76602 },
    ...
    [19] = { id = 124729, name = "L'ura", isBoss = true, displayId = 141808 },
    [20] = { id = 125340, name = "Shadewing", isBoss = true, displayId = 78427 },
...
ns.DungeonEnemies[45] = {
    ...
    [6]  = { id = 194181, name = "Vexamus", isBoss = true, displayId = 109099 },
    ...
    [10] = { id = 191736, name = "Crawth", isBoss = true, displayId = 110805 },
    ...
    [14] = { id = 196482, name = "Overgrown Ancient", isBoss = true, displayId = 109194 },
    [15] = { id = 196200, name = "Algeth'ar Echoknight", displayId = 109104 },
    [16] = { id = 196202, name = "Spectral Invoker", displayId = 109105 },
    [17] = { id = 190609, name = "Echo of Doragosa", isBoss = true, displayId = 108925 },
}
...
ns.DungeonEnemies[150] = {
    ...
    [16] = { id = 252621, name = "Krick", isBoss = true, displayId = 137499 },
    [17] = { id = 252625, name = "Ick", isBoss = true, displayId = 137500 },
    [18] = { id = 252635, name = "Forgemaster Garfrost", isBoss = true, displayId = 137504 },
    [19] = { id = 252648, name = "Scourgelord Tyrannus", isBoss = true, displayId = 137505 },
    [20] = { id = 252653, name = "Rimefang", isBoss = true, displayId = 31154 },
    [21] = { id = 254684, name = "Rotling", displayId = 138343 },
    [22] = { id = 254691, name = "Scourge Plaguespreader", displayId = 138341 },
    [23] = { id = 255037, name = "Shade of Krick", isBoss = true, displayId = 138601 },
}
...
ns.DungeonEnemies[151] = {
    ...
    [12] = { id = 75964, name = "Ranjit", isBoss = true, displayId = 56015 },
    [13] = { id = 76141, name = "Araknath", isBoss = true, displayId = 54006 },
    [14] = { id = 76142, name = "Skyreach Sun Construct Prototype", displayId = 56654 },
    [15] = { id = 76143, name = "Rukhran", isBoss = true, displayId = 125047 },
    ...
    [19] = { id = 76266, name = "High Sage Viryx", isBoss = true, displayId = 56016 },
...
ns.DungeonEnemies[152] = {
    ...
    [16] = { id = 250883, name = "Scouting Trapper", displayId = 18830 },
    ...
    [23] = { id = 231606, name = "Emberdawn", isBoss = true, displayId = 123453 },
    [24] = { id = 231626, name = "Kalis", isBoss = true, displayId = 125201 },
    [25] = { id = 231629, name = "Latch", isBoss = true, displayId = 124335 },
    [26] = { id = 231631, name = "Commander Kroluk", isBoss = true, displayId = 122981 },
    [27] = { id = 231636, name = "Restless Heart", isBoss = true, displayId = 125199 },
    ...
    [31] = { id = 238049, name = "Scouting Trapper", displayId = 139555 },
}
...
ns.DungeonEnemies[153] = {
    ...
    [2]  = { id = 251917, name = "Animated Codex", displayId = 125911 },
    ...
    [11] = { id = 231861, name = "Arcanotron Custos", isBoss = true, displayId = 131334 },
    [12] = { id = 231863, name = "Seranel Sunlash", isBoss = true, displayId = 127739 },
    [13] = { id = 231864, name = "Gemellus", isBoss = true, displayId = 131317 },
    [14] = { id = 231865, name = "Degentrius", isBoss = true, displayId = 132031 },
    ...
    [20] = { id = 239636, name = "Gemellus", isBoss = true, displayId = 141672 },
    [21] = { id = 241354, name = "Void-Infused Brightscale", displayId = 127897 },
    [22] = { id = 241397, name = "Celestial Drifter", isBoss = true, displayId = 98834 },
...
ns.DungeonEnemies[154] = {
    ...
    [19] = { id = 247570, name = "Muro'jin", isBoss = true, displayId = 130699 },
    [20] = { id = 247572, name = "Nekraxx", isBoss = true, displayId = 130705 },
    [21] = { id = 248595, name = "Vordaza", isBoss = true, displayId = 131548 },
    [22] = { id = 248605, name = "Rak'tul", isBoss = true, displayId = 131550 },
...
ns.DungeonEnemies[155] = {
    ...
    [17] = { id = 241539, name = "Kasreth", isBoss = true, displayId = 131510 },
    [18] = { id = 241542, name = "Corewarden Nysarra", isBoss = true, displayId = 131511 },
    [19] = { id = 241546, name = "Lothraxion", isBoss = true, displayId = 137705 },
